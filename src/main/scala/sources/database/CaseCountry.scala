...
object CaseCountry {
  ...
  def main (args : Array[String]) : Unit ={
    ...
    val country = Utilities.readDimData(spark, "/bigdatapgp/common_folder/project_futurecart/batchdata/futurecart_case_country_details.txt", schema)

    //Loading data to dimension table
    Utilities.loadDB(country, "DIM_CASE_COUNTRY")
  }
