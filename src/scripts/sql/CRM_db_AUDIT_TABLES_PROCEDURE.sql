...
CREATE TABLE IF NOT EXISTS CASE_DAILY_LAST_MODIFIED(
LAST_MODIFIED_DATE DATE,
LAST_MODIFIED_TS TIMESTAMP);

-- LAST MODIFIED TABLE FOR SURVEYS_DAILY (CASSANDRA)
CREATE TABLE IF NOT EXISTS SURVEYS_DAILY_LAST_MODIFIED(
LAST_MODIFIED_DATE DATE,
LAST_MODIFIED_TS TIMESTAMP);

-- LAST MODIFIED TABLE FOR CASE_REALTIME (CASSANDRA)
CREATE TABLE IF NOT EXISTS CASE_REALTIME_LAST_MODIFIED(
LAST_MODIFIED_DATE DATE,
LAST_MODIFIED_TS TIMESTAMP);

-- LAST MODIFIED TABLE FOR SURVEYS_REALTIME (CASSANDRA)
CREATE TABLE IF NOT EXISTS SURVEYS_REALTIME_LAST_MODIFIED(
LAST_MODIFIED_DATE DATE,
LAST_MODIFIED_TS TIMESTAMP);
