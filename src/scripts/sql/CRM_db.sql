...
-- CREATE EDUREKA_735821_FUTURECART_CASE_COUNTRY_DETAILS
...
CONSTRAINT FK_COUNTRY_CD FOREIGN KEY (COUNTRY_CD) REFERENCES EDUREKA_735821_FUTURECART_CASE_COUNTRY_DETAILS(ALPHA_2) ON UPDATE CASCADE ON DELETE RESTRICT, 
